  ...
  return (
    <div className="md:col-span-1 glass p-8 rounded-[0.5rem] bg-luxury-white/50 dark:bg-white/[0.02] border-black/5 dark:border-white/5 flex flex-col justify-between h-full group hover:border-emerald-500/20 transition-all">
      <div className="flex items-center justify-between mb-4">
        <div className="text-[9px] font-black uppercase tracking-[0.45em] text-luxury-charcoal/20 dark:text-white/20">{t('cashflow')}</div>
        <button
      ...
      <div>
        ...
        <div className="mt-2 text-[8px] sm:text-[9px] text-luxury-charcoal/30 dark:text-white/30 font-black uppercase tracking-[0.2em] sm:tracking-[0.35em]">
      ...
      <div className="mt-6 grid grid-cols-2 gap-4">
        ...
        <div className="p-3 sm:p-4 bg-white dark:bg-black/30 border border-black/5 dark:border-white/5 rounded-[0.5rem] flex flex-col justify-center shadow-[0_4px_20px_rgba(0,0,0,0.03)] dark:shadow-none hover:shadow-[0_4px_25px_rgba(0,0,0,0.06)] transition-shadow">
             <div className="text-[8px] sm:text-[9px] font-black uppercase tracking-[0.2em] sm:tracking-[0.35em] text-luxury-charcoal/50 dark:text-white/30 mb-1">{t('expired')}</div>
        ...
        <div className="p-3 sm:p-4 bg-white dark:bg-black/30 border border-black/5 dark:border-white/5 rounded-[0.5rem] flex flex-col justify-center shadow-[0_4px_20px_rgba(0,0,0,0.03)] dark:shadow-none hover:shadow-[0_4px_25px_rgba(0,0,0,0.06)] transition-shadow">
             <div className="text-[8px] sm:text-[9px] font-black uppercase tracking-[0.2em] sm:tracking-[0.35em] text-luxury-charcoal/50 dark:text-white/30 mb-1">{t('next_7_days')}</div>
