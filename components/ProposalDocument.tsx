               ...
               <section className="grid grid-cols-1 md:grid-cols-2 gap-16">
                  <div className="space-y-6">
                     <div className="flex items-center gap-4 text-luxury-purple">
                        ...
                        <p className="text-[11px] font-black uppercase tracking-widest">Nível de Decisão</p>
                     </div>
                  ...
                  <div className="space-y-6">
                     <div className="flex items-center gap-4 text-luxury-gold">
                        ...
                        <p className="text-[11px] font-black uppercase tracking-widest">Âmbito do Serviço</p>
                     </div>
