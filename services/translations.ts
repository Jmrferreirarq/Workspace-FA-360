...
export const translations = {
  pt: {
    ...
    calc_payment_schedule: "Plano de Pagamentos",
    calc_payment_phase: "Fase",
    calc_payment_milestone: "Marco de Entrega",
    calc_payment_percentage: "Percentagem",
    calc_payment_value: "Valor",
    calc_payment_total: "TOTAL",
    calc_payment_vat_note: "+ IVA a taxa legal",
  ...
  en: {
    ...
    calc_payment_schedule: "Payment Schedule",
    calc_payment_phase: "Phase",
    calc_payment_milestone: "Milestone",
    calc_payment_percentage: "Percentage",
    calc_payment_value: "Value",
    calc_payment_total: "TOTAL",
    calc_payment_vat_note: "+ VAT at legal rate",
